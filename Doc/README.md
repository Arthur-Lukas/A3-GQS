...
É necessários instalar o PHPUNIT para conseguir realizar os testes. E foi feito o "gitgnore" da pasta "vendor" que não está no repositório deste projeto, sendo necessário a instalação do mesmo. A instalação do vendor pode ser feita no terminal, basta dar o comando "composer install" na raiz do projeto.
